...
var utils = {
  ...
  fileName: function() {
    return context.settings.isProduction() || context.settings.isStaging() || context.settings.isIntegration() ? '[name]-[chunkhash].js' : '[name].js';
  },

  cssFileName: function() {
    return context.settings.isProduction() || context.settings.isStaging() || context.settings.isIntegration() ? '[name]-[chunkhash].css' : '[name].css';
  },

  output: function() {
    return  context.settings.isProduction() || context.settings.isIntegration() ?
